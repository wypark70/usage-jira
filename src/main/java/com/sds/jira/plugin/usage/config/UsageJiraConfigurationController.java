...
public class UsageJiraConfigurationController {
    ...
    public UsageJiraConfigurationController(PluginSettingsFactory pluginSettingsFactory, TransactionTemplate transactionTemplate, GlobalPermissionManager permissionManager, JiraAuthenticationContext authenticationContext) {
    ...
    public Response get(@Context HttpServletRequest request) {
        ...
        return Response.ok(transactionTemplate.execute(() -> {
            ...
            UsageJiraConfiguration config = new UsageJiraConfiguration();
    ...
    public Response put(final UsageJiraConfiguration config, @Context HttpServletRequest request) {
        if (isNotSystemAdmin()) return Response.status(HttpServletResponse.SC_FORBIDDEN).build();
